...
```
cd existing_repo
git remote add origin https://gitlab.com/delta7-g3/visitonline.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/delta7-g3/visitonline/-/settings/integrations)
